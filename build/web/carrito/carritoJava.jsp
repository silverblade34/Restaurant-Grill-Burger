<%-- 
    Document   : carritoJava
    Created on : 13/10/2021, 08:22:27 PM
    Author     : Michel
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="../img/logo_small_icon_only.png">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">
                        ...
                        <g transform="translate(-0.097, -7.781)"><svg width="100.0" height="84.936" x="0.097"
                                                                      y="7.781" viewBox="0.097 7.781 100 84.936">
                        <g>
                        <path
                        ...
                        <line x1="40.477999999999994" y1="35.727599999999995" x2="73.37799999999999"
                              y2="35.727599999999995" stroke="#ffff" stroke-linecap="round"></line>
        ...
        <main>
            <h2 class="text-center mt-2">Tu carrito de compras</h2>
            <div class="d-flex container-fluid justify-content-center">
                <div class="container">
                    <form action="">
                        <div class="border border-dark-50 p-4 rounded mb-5">
                            <h4 class="">Informacion de entrega</h4>
                            <label for="" class="text-success">Ingresa tu direccion de entrega</label>
                            <input type="text" class="form-control">
                            <label for="" class="text-success mt-2">Tipo de vivienda</label>
                            ...
                            <label for="" class="text-success mt-2">Numero de celular</label>
                            <input type="text" name="" id="" class="form-control">
                            <label for="" class="text-success mt-2">Referencia</label>
                            <input type="text" name="" id="" class="form-control">
                        </div>
                        <div class="d-grid gap-2">
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <c:forEach var = "producto" items = "${productosCarrito}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="${pageContext.request.contextPath}/ServletProducto?opt=I&id=${producto.idProducto}" width="100px" height="100px">
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                    </tbody>
                            ...
                            <button type="button" class="btn btn-outline-success">Seguir comprando</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <footer class=" container-fluid justify-content-center bg-dark mt-5">
            <div class="container-fluid text-light row bg-dark" style="padding-top: 25px;">
                ...
                <div class="col-lg-3">
                    ...
                    <p><i class='bx bx-receipt'></i><a href="#" class="enlaces-footer"> Terminos y condiciones de uso</a>
                    </p>
