<%-- 
    Document   : indexCarta
    Created on : 09/10/2021, 10:53:51 AM
    Author     : Michel
--%>
...
<html>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="link-navbar nav-link active " href="index.jsp"> Promociones</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active text-primary" href="#"> Nuestra carta</a>
                            </li>
                            <li class="nav-item">
        ...
        <main>
            <h2 class="text-center mt-2">Hamburguesas</h2>
            <div class="d-flex row container-fluid justify-content-center mb-5">
                <%
                    ArrayList<productosBeans> lista = (ArrayList<productosBeans>) request.getAttribute("lista");

                    for (int i = 0; i < lista.size(); i++) {
                        productosBeans pro = lista.get(i);
                        if (pro.getCetegoria() == 1) {

                %>
                <div class="card-hover col-lg-4 mt-4" style="max-width: 380px;">
                    <a href="servletCRUD?op=consulta&cod=<%=pro.getIdProducto()%>" class="enlaces-cuerpo">
                        <div class="card">
                            <div class="row">
                               <div class="col-6">
                                   <img src="<%=pro.getImagen()%>" alt="" class="rounded-start" height="100%" width="100%">
                                </div>
                                <div class="col-6" style="min-height: 150px">
                                    <h6 class="text-success text-center mt-2"><%=pro.getNombreProducto()%></h6>
                                    <p class="text-dark" style="max-height: 50px; overflow: hidden;"><%=pro.getDescripcion()%></p>
                                    <p class="text-dark fw-bold">Precio: S/. <span><%=pro.getPrecio()%></span></p>
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            <h2 class="text-center mt-2">Combinados Papacheros</h2>
            <div class="d-flex row container-fluid justify-content-center mb-5">
                <%
                    for (int i = 0; i < lista.size(); i++) {
                        productosBeans pro = lista.get(i);
                        if (pro.getCetegoria() == 2) {
            ...
            <h2 class="text-center mt-2">Nuestras alitas</h2>
            <div class="d-flex row container-fluid justify-content-center mb-5">
                <%
                    for (int i = 0; i < lista.size(); i++) {
                        productosBeans pro = lista.get(i);
                        if (pro.getCetegoria() == 3) {
            ...
            <h2 class="text-center mt-2">Nuestros Hot Dogs y salchipapas</h2>
            <div class="d-flex row container-fluid justify-content-center mb-5">
                <%
                    for (int i = 0; i < lista.size(); i++) {
                        productosBeans pro = lista.get(i);
                        if (pro.getCetegoria() == 4) {
            ...
            <h2 class="text-center mt-2">Refrescos</h2>
            <div class="d-flex row container-fluid justify-content-center mb-5">
                <%
                    for (int i = 0; i < lista.size(); i++) {
                        productosBeans pro = lista.get(i);
                        if (pro.getCetegoria() == 5) {
                ...
                <div class="card-hover col-lg-4 mt-4" style="max-width: 380px;">
                     <div class="card">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <h6 class="text-success text-center mt-1"><%=pro.getNombreProducto()%></h6>
                                <p class="text-dark" style="max-height: 20px; overflow: hidden;"><%=pro.getDescripcion()%></p>
                                <p class="text-dark fw-bold">Precio: S/. <span><%=pro.getPrecio()%></span></p>
                                <div class="row me-4">
                                    <span class="col-7">Cantidad: </span> <input type="text" class="col-5" id="inputCantidadPorcion">
                                </div>
                                <div class="d-flex justify-content-center container-fluid mt-2">
                                    <button class="btn btn-primary text-center mb-2" type="button" width="80%">Agregar</button>
                                </div> 
                            </div>
                        </div>
                    </div>
            ...
            <h2 class="text-center mt-2">Cervezas</h2>
            <div class="d-flex row container-fluid justify-content-center mb-5">
                <%
                    for (int i = 0; i < lista.size(); i++) {
                        productosBeans pro = lista.get(i);
                        if (pro.getCetegoria() == 6) {
