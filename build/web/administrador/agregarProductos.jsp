...
<html>
    ...
    <body>
        ...
        <main>
            <h2 align="center" class="mt-3">Agregue productos a su catalogo virtual</h2>
                    ...
                    <div class="row p-4" >
                        ...
                        <div class="col-lg-7">
                            <h4 class="text-success text-center">DATOS DEL NUEVO PRODUCTO</h3>
                                <form action="../servletCRUD" class="row" method="post">
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <select class="form-select" name="categoriaProducto" id="">
                                            ...
                                            <option value="6">Cerveza</option>
                                            <option value="7">Promociones</option>
                                        </select>
                                    </div>
                                    <div class="col-12 mt-2">
                                    ...
                                    <div class="d-grid gap-2 mt-3">
                                        <input type="submit" name="btn" class="btn btn-primary" value="Registrar producto">
                                    </div>
                                </form>
                        </div>
                    </div>
