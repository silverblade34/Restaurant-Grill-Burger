<%-- 
    Document   : listadoAdmi
    Created on : 10/10/2021, 05:20:12 PM
    Author     : Michel
--%>
...
<html>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class=" nav-link active text-primary " href="../servletCRUD?op=listarAdmi"><i class='bx bx-list-ol' style='color:#ffffff'></i>Tus productos</a>
                            </li>
                            <li class="nav-item">
                                <a class=" link-navbar nav-link active " href="administrador/agregarProductos.jsp"><i class='bx bxs-book-add'></i> Agregar productos</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container">
            <h2 align="center" class="mt-3">Listado de productos</h2>
            <table class="table">
                <tr>
                    <th class="text-success">ID-PRODUCTO</th><th class="text-success">NOMBRE</th><th class="text-success">DESCRIPCION</th><th class="text-success">IMAGEN</th>
                    <th class="text-success">PRECIO</th><th class="text-success">CATEGORIA</th><th class="text-success">ELIMINAR</th><th class="text-success">EDITAR</th>
                </tr>
                 <%
                ...
                %>
                      <tr>
                          ...
                          <td><%=pro.getImagen() %></td>
                          <td><%=pro.getPrecio() %></td>
                          <td><%=pro.getCetegoria() %></td>
                          <td>
                              <a href="servletCRUD?op=eliminar&cod=<%=pro.getIdProducto() %>">
                                  <i class='bx bx-sm bxs-trash bx-tada-hover' style='color:#e20c0c' ></i>
                              </a>
                          </td>
                          <td>
                              <a href="#">
                                <i class='bx bx-sm bxs-pencil bx-tada-hover' style='color:#27e20c'  ></i>
                              </a>
                          </td>
                      </tr>
                     <%
