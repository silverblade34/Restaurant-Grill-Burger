                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="link-navbar nav-link active " href="index.html"> Promociones</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="carrito/carritoJava.jsp" class="link-navbar nav-link active"><i class='bx bx-cart'></i> Tu carrito</a>
                            </li>
                        </ul>
                        <form class="d-flex">
                            <input class="form-control me-2" type="search" placeholder="Buscar en catalogo" aria-label="Search">
