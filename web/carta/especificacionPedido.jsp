<%-- 
    Document   : especificacionPedido
    Created on : 09/10/2021, 10:44:13 PM
    Author     : Michel
--%>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a href="carrito/index.html" class="link-navbar nav-link active"><i class='bx bx-cart'></i> Tu carrito</a>
                            </li>
                        </ul>
                        <form class="d-flex">
        ...
        <main>
            <form action="action">
                ...
                %>
                <div class="container-fluid mt-5 mb-5" style="max-width: 1100px;">
                    <div class="card">
                        <div class="row">
                            ...
                            <div class="col-lg-6 ps-4">
                                <h3 class="text-success text-center mt-3"><%=pro.getNombreProducto()%></h3>
                                <p class="text-dark" style="max-height: 45px; overflow: hidden;"><%=pro.getDescripcion()%></p>
                                <label>Elige el tamaño de tu porcion</label>
                                <div class="form-check">
                                    <input class="form-check-input"  type="radio" id="huey" name="drone" value="huey"
                                           checked>
                                    <label class="form-check-label" for="flexRadioRegular">
                                        Regular
                                    </label>
                                </div>

                                <div class="form-check">
                                    <input class="form-check-input"  type="radio" id="dewey" name="drone" value="dewey">
                                    <label class="form-check-label" for="flexRadioMediana">
                                        Mediana
                                    </label>
                                </div>

                                <div class="form-check">
                                    <input class="form-check-input"  type="radio" id="louie" name="drone" value="louie">
                                    <label class="form-check-label" for="flexRadioGrande">
                                        Grande
                                    </label>
                                </div>

                                <label>Elige que salsas deseas:</label>
                                <div class="form-check">
                                ...
                                <div class="mt-3">
                                    <span>Cantidad de porciones: </span><input type="number" class="" id="inputCantidadPorcion">
                                </div>
                                <p class="text-dark mt-3">Precioxunid: S/. <span><%=pro.getPrecio()%></span></p>
                                <div class="d-flex justify-content-center container-fluid">
                                    <a href = "${pageContext.request.contextPath}/ServletCRUD?idProducto=${producto.idProducto}&opt=A" class="btn btn-primary text-center mb-4" type="button" width="80%">Agregar al carrito</a>
                                </div> 
                            </div>
                        </div>
                    </div>
